-- <Migration ID="18f8f684-d8dd-42b3-9429-94ac64b45944" TransactionHandling="Custom" />
GO
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Production].[UQ__Document__F73921F70D6A716A]', 'UQ') AND parent_object_id = OBJECT_ID(N'[Production].[Document]', 'U'))
ALTER TABLE [Production].[Document] ADD CONSTRAINT [UQ__Document__F73921F70D6A716A] UNIQUE NONCLUSTERED ([rowguid])
GO
